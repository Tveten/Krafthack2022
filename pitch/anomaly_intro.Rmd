...
We have chosen to augment the data set by introducing two new modes: "burnin" and "shutdown". In addition, we have introduced a new feature $f$ given by 
$$
f = \frac{1}{t^{1/4}},
$$
