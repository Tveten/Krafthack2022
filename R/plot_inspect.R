#' @export
capa_external_line_plot <- function(object, epoch = dim(object$x)[1],
...
#' @export
capa_external_tile_plot <- function(object, variate_names = NULL,
...
#' @export
plot_capacc_external <- function(object, epoch = n,
                        subset = 1:p, variate_names = NULL,
                        true_anoms = NULL) {
  # plot.capa_externalcc <- function(object, epoch = n,
  #                         subset = 1:p, variate_names = NULL,
  ...
  # }
  if (length(subset) <= 30)
    return(capa_external_line_plot(object, epoch, subset, variate_names, true_anoms))
  else
    return(capa_external_tile_plot(object, variate_names, epoch, subset, true_anoms))
}
